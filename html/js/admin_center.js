...
function userinfo() {
	...
	$.ajax({
		...
		success: function (data) {
			...
			$.ajax({
				type: "post",
				url: "/apiz/admin_center/province",
				dataType: "json",
				success: function (data) {
...
function img() {
	...
	$(".user").html("");
	var txt = "";
	txt += `<img src="/apiz/adminheadImg?id=${userid}" onerror="defaultImg(this)" style="
    width: 50px;
    height: 50px;
...
function img2() {
	...
	$(".checkimg").html("");
	var txt = "";
	txt += `<img id="demo1" src="/apiz/adminheadImg?id=${userid}" onerror="defaultImg(this)" style="
    width: 200px;
    height: 200px;
    border-radius: 200px;">`
	$(".checkimg").append(txt);
...
layui.use('form', function () {
	...
	form.on('submit(formDemo)', function (data) {
		...
		$.ajax({
			type: "post",
			url: "/apiz/admin_center/changeUserinfo",
			data: {
				userid: userid,
...
layui.use('form', function () {
	...
	form.on("select(county)", function (data) {
		...
		$.ajax({
			type: "post",
			url: "/apiz/admin_center/district",
			data: {
				id: id,
			},
			dataType: "json",

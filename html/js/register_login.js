...
//document.getElementById("label2").innerHTML="<font color='red'>提示内容</font>"
//document.getElementById("label3").innerHTML="<font color='red'>提示内容</font>"
	var form = layui.form;
	//监听提交
			...
			success: function (data) {
				...
				if (data.code == 1) {
					sessionStorage.setItem("id", data.userid);
						...
						alert(data.msg);
						location.href = "register_main_map.html"
				} else {
					//alert(data.msg);

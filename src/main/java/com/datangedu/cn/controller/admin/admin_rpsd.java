...
@Controller
@RequestMapping("/admin_upwd")
public class admin_rpsd {
	@Resource
	...
	public Map <String,Object> Login(HttpServletRequest request) {
		...
		//查找手机号是否存在
		List<Adminstrator> userInfo = adminservice.Selectbycellphone(cellphone);
		if(userInfo.isEmpty()) {
			map.put("msg","手机号不存在" );
			map.put("status",2);
			return map;
		...
		int a = adminservice.updatepassword(mu,cellphone);

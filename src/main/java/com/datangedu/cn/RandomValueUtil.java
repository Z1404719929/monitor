...
public class RandomValueUtil {
    ...
    private static final String[] nas="cctv,湖南卫视".split(",");
    ...
    public static String getnas() {
        int index=getNum(0,nas.length-1);
        String first=nas[index];
        return first;
    }
...
//    	System.out.println("b=========="+b+"===="+c);
        for (int i = 0; i < 100; i++) {		
    			...
    			System.out.println(RandomValueUtil.getnas());
        }
        String file = "D:\\3software\\a.txt";
        try {
